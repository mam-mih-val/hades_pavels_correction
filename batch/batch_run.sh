...
echo "executing $build_dir/yield -i $filelist -t hades_analysis_tree -n -1 -o yield.root --cuts-macro Hades/AuAu1.23.C --pdg-code $pdg_code --q-vector-file=correction_out.root --q-vector-name=W1_PLAIN --cuts-macro=Hades/AuAu1.23.C"
